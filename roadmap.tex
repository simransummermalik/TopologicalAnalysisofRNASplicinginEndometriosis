% Include from the existing main document with \input{roadmap}.
...
The following commands illustrate the intended interface; they are not yet
implemented, and the tool name is a placeholder:
\begin{verbatim}
tool analyze sample.tsv
tool gene GENE_ID --case cases/ --control controls/
tool compare --case cases/ --control controls/
tool rank --genes candidate_genes.tsv \
